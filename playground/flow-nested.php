      ...
      'method' => Prompty::select('Method',
        ...
        children: [
          'temperature' => Prompty::select('Temperature',
            ...
            condition: fn($r): bool => in_array($r['method'] ?? '', ['baked', 'grilled']),
          ),
